...
class ManagedAppRepositoryImpl @Inject constructor(private val managedAppDao: ManagedAppDao) : ManagedAppRepository {
    ...
    override suspend fun addManagedApp(managedApp: ManagedApp) {
        ManagedAppValidator.validate(managedApp)
        managedAppDao.insertManagedApp(ManagedAppMapper.mapToEntity(managedApp))
    }

    override suspend fun updateManagedApp(managedApp: ManagedApp) {
        ManagedAppValidator.validate(managedApp)
